...
public class BuyerService{
	...
	public Buyer getbuyerbybuyerId(Integer buyerId) throws Exception
	{
		...
		{
			throw new Exception("No buyer Available!!");
		}
	}
	...
	public String errormsg="You are Inactive. Please Login";
	...
	public String deletProductFromWhishlist(Integer prodId) {
		...
		else if(buyerState(whishlist.getBuyerId())) {
	...
	public String deletProductFromCart(Integer prodId) {
		Cart cart=cartRepository.findById(prodId).orElse(null);
		if(cart==null)
			return "Product does not exist";
		else if(buyerState(cart.getBuyerId())) {
